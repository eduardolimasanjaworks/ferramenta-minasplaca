...
**GMX** (0 passadas, 0.0s)
- Cenário plano: disponibilidade programático (pede_destino_atual)
- Ferramentas: nenhuma
- Fila: 0/4 slots, 0 aguardando
...
### Turno 6 — Validação
❌ **FALHA**: faltou:data|liber

### Turno 7 — Motorista
> libero sexta-feira

**GMX** (0 passadas, 0.0s)
- Cenário plano: disponibilidade programático (destino_atual_invalido)
- Ferramentas: nenhuma
- Fila: 0/4 slots, 0 aguardando
...
### Turno 10 — Validação
❌ **FALHA**: faltou:dados atualizados|boa viagem|show, faltou_ferramenta_registrar_disponibilidade
